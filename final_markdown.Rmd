...
```{r, message = FALSE, error=FALSE, fig.height = 5, fig.width = 6}
ggmap(map) +
...
```{r kable table detailing variables, echo=FALSE}
...
```{r Distribution of dependent variables, message = FALSE, out.width=c('50%', '50%'), fig.show='hold'}
ggplot(vars_train) +
...
```{r number of trips per day, message = FALSE, out.width=c('50%', '50%'), fig.show='hold'}
vars_train %>%
...
```{r app pic1, echo=FALSE, fig.width=8, fig.height=4, fig.align='center'}
readPNG("C:/Users/MaiRZ/Desktop/a.png") %>%
  grid.raster(.)
...
```{r app pic2, echo=FALSE, fig.width=12, fig.height=6,fig.align='center'}
readPNG("C:/Users/MaiRZ/Desktop/b.png") %>%
  grid.raster(.)
...
```{r app pic3, echo=FALSE, fig.width=12, fig.height=6,fig.align='center'}
readPNG("C:/Users/MaiRZ/Desktop/c.png") %>%
  grid.raster(.)
...
```{r app pic4, echo=FALSE, fig.width=12, fig.height=12,fig.align='center'}
readPNG("C:/Users/MaiRZ/Desktop/d.png") %>%
  grid.raster(.)
